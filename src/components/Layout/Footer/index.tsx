...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pt-16 dark:bg-dark md:pt-20 lg:pt-24 border-t border-luxury-gold/20">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark font-serif">
                  Crafting eternity through exquisite manufacturing and timeless design. Laxminarayan is your partner in luxury.
                </p>
                <div className="flex items-center">
                  <a
                    href="/"
                    aria-label="social-link"
                    className="mr-6 text-body-color duration-300 hover:text-luxury-gold dark:text-body-color-dark dark:hover:text-luxury-gold"
                  >
                    {/* Facebook Icon */}
                  ...
                  <a
                    href="/"
                    aria-label="social-link"
                    className="text-body-color duration-300 hover:text-luxury-gold dark:text-body-color-dark dark:hover:text-luxury-gold"
                  >
                    {/* Instagram Icon */}
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white font-serif">
                  Explore
                </h2>
                <ul>
                  <li>
                    <Link
                      href="/collections"
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-luxury-gold dark:text-body-color-dark dark:hover:text-luxury-gold"
                    >
                      Collections
                    </Link>
                  </li>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              &copy; {new Date().getFullYear()} Laxminarayan. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
